...
const Footer = () => {
  return (
    <footer
      className="bg-black-100 text-black-200 pt-2 px-2 w-full"
      id="contact"
    >
      <div className="flex flex-col space-y-4 justify-center items-center h-auto  border-b py-4 border-black-200  px-2">
      ...
      <div className="flex text-black-200 justify-center items-center flex-wrap text-center  sm:px-16  py-2 lg:py-2  text-[0.7rem] md:text-sm">
